...
public class ActivitySendPushNotification extends BaseActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, EndPoints.URL_FETCH_DEVICES,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ActivitySendPushNotification.this, ""+error, Toast.LENGTH_SHORT).show();
