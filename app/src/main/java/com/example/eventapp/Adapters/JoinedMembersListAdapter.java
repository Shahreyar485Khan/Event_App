...
public class JoinedMembersListAdapter extends RecyclerView.Adapter<JoinedMembersListAdapter.JoinedMembersListViewHolder> {

    public static List<String> namesList;
    public static List<String> emailList;
    public static List<String> idList;
    final private JoinedMembersListAdapter.JoinedMembersListAdapterOnClickHandler mClickHandler;
    private final JoinedMembersListAdapter.AdapterListener onClickListener;

    public interface JoinedMembersListAdapterOnClickHandler {
    ...
    public JoinedMembersListAdapter(JoinedMembersListAdapterOnClickHandler handler, AdapterListener listener, Context context) {
    ...
    @NonNull
    @Override
    public JoinedMembersListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        Context context = parent.getContext();
        int layoutId = R.layout.joined_member_list_item;
        LayoutInflater inflater = LayoutInflater.from(context);
        boolean shouldAttachToParentImmediately = false;

        View view = inflater.inflate(layoutId, parent, shouldAttachToParentImmediately);

        return new JoinedMembersListViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull JoinedMembersListViewHolder holder, final int position) {
    ...
    public class JoinedMembersListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

        final TextView nameTextView;
        final Button sendButton;

        JoinedMembersListViewHolder(@NonNull View itemView) {
            super(itemView);
