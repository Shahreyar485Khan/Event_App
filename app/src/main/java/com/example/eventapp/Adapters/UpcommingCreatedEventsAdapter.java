...
public class UpcommingCreatedEventsAdapter extends RecyclerView.Adapter<UpcommingCreatedEventsAdapter.UpcommingCreatedEventsAdapterViewHolder> {
  ...
  //  private final UpcommingCreatedEventsAdapter.AdapterListener onClickListener;
    ...
    @NonNull
    @Override
    public UpcommingCreatedEventsAdapter.UpcommingCreatedEventsAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        Context context = parent.getContext();
        int layoutId = R.layout.upcomming_created_events_item;
        LayoutInflater inflater = LayoutInflater.from(context);
        boolean shouldAttachToParentImmediately = false;

        View view = inflater.inflate(layoutId, parent, shouldAttachToParentImmediately);

        return new UpcommingCreatedEventsAdapter.UpcommingCreatedEventsAdapterViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UpcommingCreatedEventsAdapter.UpcommingCreatedEventsAdapterViewHolder holder, final int position) {
...
//        });
    ...
    public class UpcommingCreatedEventsAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
      ...
      //  TextView txtEndDate;
        ...
        UpcommingCreatedEventsAdapterViewHolder(@NonNull View itemView) {
            super(itemView);
